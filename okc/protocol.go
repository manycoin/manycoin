...
var ProtocolName = "okc"

// Supported versions of the okc protocol (first is primary).
var ProtocolVersions = []uint{okc63, okc62}
...
// okc protocol message codes
const (
	// Protocol messages belonging to okc/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to okc/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
