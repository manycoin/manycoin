...
// information related to the Okcoin protocol such als blocks, transactions and logs.
...
// `okc_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/okcoin/wiki/wiki/JSON-RPC#okc_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with okc_getFilterChanges.
//
// https://github.com/okcoin/wiki/wiki/JSON-RPC#okc_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(okcoin.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
//
// TODO(karalabe): Kill this in favor of okcoin.FilterQuery.
...
//
// https://github.com/okcoin/wiki/wiki/JSON-RPC#okc_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(okcoin.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/okcoin/wiki/wiki/JSON-RPC#okc_getlogs
...
//
// https://github.com/okcoin/wiki/wiki/JSON-RPC#okc_uninstallfilter
...
//
// https://github.com/okcoin/wiki/wiki/JSON-RPC#okc_getfilterlogs
...
//
// https://github.com/okcoin/wiki/wiki/JSON-RPC#okc_getfilterchanges
