...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (okc/61) or header (okc/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (okc/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both okc/61 and okc/62)
}
...
func (f *Fetcher) insert(peer string, block *types.Block) {
	...
	go func() {
		...
		default:
			// Somokcing went very wrong, drop the peer
