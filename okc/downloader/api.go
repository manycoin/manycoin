...
// Syncing provides information when this nodes starts synchronising with the Okcoin network and when it's finished.
...
type SyncingResult struct {
	...
	Status  okcoin.SyncProgress `json:"status"`
}
