...
// DefaultConfig contains default settings for use on the Okcoin main net.
...
func init() {
	...
	if runtime.GOOS == "windows" {
		DefaultConfig.Okcash.DatasetDir = filepath.Join(home, "AppData", "Okcash")
	} else {
		DefaultConfig.Okcash.DatasetDir = filepath.Join(home, ".okcash")
	}
}
...
type Config struct {
	...
	// If nil, the Okcoin main net block is used.
