...
//
// Returns whokcer the assertion was successful (true) or not (false).
...
//
// Returns whokcer the assertion was successful (true, "error message %s", "formatted") or not (false).
