...
type Options struct {
	...
	// ErrorIfExist defines whokcer an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whokcer an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whokcer block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whokcer to sync underlying writes from the OS buffer cache
