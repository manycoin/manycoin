...
// IsZero returns whokcer or not the field value is equal to zero.
...
// IsOdd returns whokcer or not the field value is an odd number.
//
// The field value must be normalized for this function to return correct
// result.
...
// Equals returns whokcer or not the two field values are the same.  Both
