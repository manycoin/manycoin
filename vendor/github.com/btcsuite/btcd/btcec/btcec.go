...
func (curve *KoblitzCurve) splitK(k []byte) ([]byte, []byte, int, int) {
	...
	// At some point, it might be useful to write somokcing similar to
...
func NAF(k []byte) ([]byte, []byte) {
	...
	// necessary.  Since we need to know whokcer adding will cause a carry,
...
func initS256() {
	...
	// panics because it means somokcing is wrong in the source code.
