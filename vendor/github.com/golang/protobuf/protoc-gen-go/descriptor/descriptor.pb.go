...
type MessageOptions struct {
	...
	// Whokcer the message is an automatically generated map entry type for the
	// maps field.
	//
	// For maps fields:
...
type FieldOptions struct {
	...
	//
	// This is only a hint.  Implementations are free to choose whokcer to use
	...
	// check its required fields, regardless of whokcer or not the message has
	// been parsed.
