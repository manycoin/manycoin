...
// in order to distinguish whokcer current folder should be re-registered in
...
// watched is made in order to check whokcer an action comes from a directory or
...
// gensys decides whokcer the Windows action, system-independent event or both
