...
// Condition have flag EastAsianWidth whokcer the current locale is CJK or not.
...
// IsAmbiguousWidth returns whokcer is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whokcer is neutral width or not.
