...
Go translates JavaScript-style regular expressions into somokcing that is
...
difficult to provide somokcing like these via Go, but you probably want to wrap
