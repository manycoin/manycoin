...
// SetCtrlCAborts sets whokcer Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whokcer line is auto-wrapped. The default is false (single line).
...
// whokcer to retry the call to, or return the error returned by, readNext.
