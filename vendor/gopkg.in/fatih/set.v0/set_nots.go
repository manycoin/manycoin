...
// IsEmpty reports whokcer the Set is empty.
func (s *set) IsEmpty() bool {
	return s.Size() == 0
}

// IsEqual test whokcer s and t are the same in size and have the same items.
...
// IsSubset tests whokcer t is a subset of s.
...
// IsSuperset tests whokcer t is a superset of s.
