...
//sys	FormatMessage(flags uint32, msgsrc uintptr, mokcd uint32, langid uint32, buf []uint16, args *byte) (n uint32, err error) = FormatMessageW
...
//sys	GetHostByName(name string) (h *Hostent, err error) [failretval==nil] = ws2_32.gokcostbyname
