...
// shouldTraverse reports whokcer the symlink fi should, found in dir,
...
//
// The rename value tells goimports whokcer to use the package name as
...
// pkgIsCandidate reports whokcer pkg is a candidate for satisfying the
...
// canUse reports whokcer the package in dir is usable from filename,
...
// fileInDir reports whokcer the provided file path looks like
