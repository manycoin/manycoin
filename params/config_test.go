...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllOkcashProtocolChanges, new: AllOkcashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllOkcashProtocolChanges, new: AllOkcashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllOkcashProtocolChanges,
