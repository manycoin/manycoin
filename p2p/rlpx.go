...
import (
	...
	"github.com/okcoin/go-okcoin/crypto/ecies"
	"github.com/okcoin/go-okcoin/crypto/secp256k1"
...
// and also verifies whokcer the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whokcer read packet had plain format.
