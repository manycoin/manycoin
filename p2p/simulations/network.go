...
import (
	...
	"github.com/okcoin/go-okcoin/p2p/simulations/adapters"
)
...
// NOTE:
// it also checks whokcer there has been recent attempt to connect the peers
...
type Node struct {
	...
	// Up tracks whokcer or not the node is running
	Up bool `json:"up"`
}
...
type Conn struct {
	...
	// Up tracks whokcer or not the connection is active
	Up bool `json:"up"`
...
// nodesUp returns whokcer both nodes are currently up
