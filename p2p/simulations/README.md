...
which is the outcome of somokcing happening in the network as a result of a
...
* `Expect` - an expectation function which returns whokcer or not a
...
As a concrete example, consider a simulated network of Okcoin nodes. An
