...
// Contains reports whokcer the given IP is contained in the list.
...
// IsLAN reports whokcer an IP is a local network address.
...
// IsSpecialNetwork reports whokcer an IP is located in a special-use network range
...
// CheckRelayIP reports whokcer an IP relayed from the given sender IP
...
// SameNet reports whokcer two IP addresses have an equal prefix of the given bit length.
...
// Contains whokcer the given IP is contained in the set.
