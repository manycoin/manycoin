...
func newTestLDB() (*okcdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "okcdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := okcdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db okcdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db okcdb.Database, t *testing.T) {
	const n = 8
