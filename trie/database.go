...
type DatabaseReader interface {
	...
	// Has retrieves whokcer a key is present in the database.
...
type Database struct {
	diskdb okcdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb okcdb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch okcdb.Batch) error {
	// If the node does not exist, it's a previously committed node
