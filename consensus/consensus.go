...
// Package consensus implements different Okcoin consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the Okcoin address of the account that minted the given
	// block, which may be different from the header's coinbase if a consensus
	// engine is based on signatures.
	Author(header *types.Header) (common.Address, error)

	// VerifyHeader checks whokcer a header conforms to the consensus rules of a
	...
	// VerifySeal checks whokcer the crypto seal on a header is valid according to
