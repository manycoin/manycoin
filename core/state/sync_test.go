...
// account array.
func checkStateAccounts(t *testing.T, db okcdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db okcdb.Database, root common.Hash) error {
...
func checkStateConsistency(db okcdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(okcdb.Database), srcRoot)
