...
// Package state provides a caching layer atop the Okcoin state trie.
package state
...
// StateDBs within the okcoin protocol are used to store anything
...
// Exist reports whokcer the given account address exists in the state.
// Notably this also returns true for suicided accounts.
func (self *StateDB) Exist(addr common.Address) bool {
	return self.getStateObject(addr) != nil
}

// Empty returns whokcer the state object is either non-existent
...
//
// Carrying over the balance ensures that Okcer doesn't disappear.
