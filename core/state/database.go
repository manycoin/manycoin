...
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb okcdb.Putter) error
}
...
func NewDatabase(db okcdb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb okcdb.Putter) error {
