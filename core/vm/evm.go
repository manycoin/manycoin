...
type Context struct {
	// CanTransfer returns whokcer the account contains
	// sufficient okcer to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers okcer from one account to the other
...
// EVM is the Okcoin Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) okcoin virtual machine
...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	...
	// check whokcer the max code size has been exceeded
