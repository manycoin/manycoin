...
type operation struct {
	...
	halts   bool // indicates whokcer the operation should halt further execution
	jumps   bool // indicates whokcer the program counter should not increment
	writes  bool // determines whokcer this a state modifying operation
	valid   bool // indication whokcer the retrieved operation is valid and known
	reverts bool // determines whokcer the operation reverts state (implicitly halts)
	returns bool // determines whokcer the operations sets the return data content
}
