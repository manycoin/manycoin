...
// Package types contains data types related to Okcoin consensus.
package types
...
// Header represents a block header in the Okcoin blockchain.
type Header struct {
...
// Block represents an entire block in the Okcoin blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package okc to track
...
// [deprecated by okc/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for okc protocol, etc.
...
// EncodeRLP serializes b into the Okcoin RLP block format.
