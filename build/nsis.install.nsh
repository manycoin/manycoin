Name "gokc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/okcoin/go-okcoin/issues"
!define UPDATEURL "https://github.com/okcoin/go-okcoin/releases"
!define ABOUTURL "https://github.com/okcoin/go-okcoin#okcoin-go"
...
# Install gokc binary
Section "Gokc" GOKC_IDX
  SetOutPath $INSTDIR
  file {{.Gokc}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gokc.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gokc.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gokc incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gokc outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gokc UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gokc incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gokc.exe" "" "" "Okcoin" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gokc outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gokc.exe" "" "" "Okcoin" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gokc UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gokc.exe" "" "" "Okcoin" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/okcoin/EIPs/issues/147)
  ${EnvVarUpdate} $0 "OKCEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gokc.ipc"
  ${EnvVarUpdate} $0 "OKCEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gokc.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GOKC_IDX}
    SectionGetSize ${GOKC_IDX} $0
