...
# 1. install gokc for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gokc
# 5. create gokc, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable OKCEREUM_SOCKET
...
!define GROUPNAME "Okcoin"
!define APPNAME "Gokc"
!define DESCRIPTION "Official Go implementation of the Okcoin protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gokc is installed global
