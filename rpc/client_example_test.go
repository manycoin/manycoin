...
//
// okc_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// okc_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.OkcSubscribe(ctx, subch, "newBlocks")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "okc_getBlockByNumber", "latest"); err != nil {
