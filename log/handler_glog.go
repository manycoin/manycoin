...
type GlogHandler struct {
	...
	override  uint32 // Flag whokcer overrides are used, atomically accessible
	backtrace uint32 // Flag whokcer backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whokcer this is the callsite
