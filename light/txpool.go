...
// to the OKC network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whokcer a transaction is valid according to the consensus rules.
