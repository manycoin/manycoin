...
import (
	...
	"github.com/okcoin/go-okcoin/log/term"
	"github.com/okcoin/go-okcoin/metrics"
	"github.com/okcoin/go-okcoin/metrics/exp"
...
var (
	...
	vmoduleFlag = cli.StringFlag{
		Name:  "vmodule",
		Usage: "Per-module verbosity: comma-separated list of <pattern>=<level> (e.g. okc/*=5,p2p=4)",
		Value: "",
	}
