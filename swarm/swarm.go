...
import (
	...
	"github.com/okcoin/go-okcoin/contracts/chequebook"
	"github.com/okcoin/go-okcoin/contracts/ens"
	...
	httpapi "github.com/okcoin/go-okcoin/swarm/api/http"
	"github.com/okcoin/go-okcoin/swarm/fuse"
	"github.com/okcoin/go-okcoin/swarm/network"
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config) (*ens.ENS, error) {
	...
	ensClient := okcclient.NewClient(client)
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := okcclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
