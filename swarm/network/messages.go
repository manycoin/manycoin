...
import (
	...
	"github.com/okcoin/go-okcoin/swarm/network/kademlia"
	"github.com/okcoin/go-okcoin/swarm/services/swap"
...
Timeout serves to indicate whokcer the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whokcer responder is expected to deliver content
