...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gokc.ipc", false, filepath.Join(os.TempDir(), "gokc.ipc")},
		{"data", "gokc.ipc", false, "data/gokc.ipc"},
		{"data", "./gokc.ipc", false, "./gokc.ipc"},
		{"data", "/gokc.ipc", false, "/gokc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gokc.ipc", true, `\\.\pipe\gokc.ipc`},
		{"data", "gokc.ipc", true, `\\.\pipe\gokc.ipc`},
		{"data", `\\.\pipe\gokc.ipc`, true, `\\.\pipe\gokc.ipc`},
	}
