...
// Creates an okcoin address given the bytes and the nonce
...
// controls whokcer the key's length should be enforced at the curve size or
...
// ValidateSignatureValues verifies whokcer the signature values are valid with
