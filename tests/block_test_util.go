...
// Package tests implements execution of Okcoin JSON tests.
package tests
...
func (t *BlockTest) Run() error {
	...
	chain, err := core.NewBlockChain(db, nil, config, okcash.NewShared(), vm.Config{})
	if err != nil {
		return err
	}
	defer chain.Stop()
...
/* See https://github.com/okcoin/tests/wiki/Blockchain-Tests-II

   Whokcer a block is valid or not is a bit subtle, it's defined by presence of
