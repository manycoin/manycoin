...
const (
	...
	MessageType_MessageType_OkcoinGetAddress       MessageType = 56
	MessageType_MessageType_OkcoinAddress          MessageType = 57
	MessageType_MessageType_OkcoinSignTx           MessageType = 58
	MessageType_MessageType_OkcoinTxRequest        MessageType = 59
	MessageType_MessageType_OkcoinTxAck            MessageType = 60
	...
	MessageType_MessageType_OkcoinSignMessage      MessageType = 64
	MessageType_MessageType_OkcoinVerifyMessage    MessageType = 65
	MessageType_MessageType_OkcoinMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_OkcoinGetAddress",
	57:  "MessageType_OkcoinAddress",
	58:  "MessageType_OkcoinSignTx",
	59:  "MessageType_OkcoinTxRequest",
	60:  "MessageType_OkcoinTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_OkcoinSignMessage",
	65:  "MessageType_OkcoinVerifyMessage",
	66:  "MessageType_OkcoinMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_OkcoinGetAddress":       56,
	"MessageType_OkcoinAddress":          57,
	"MessageType_OkcoinSignTx":           58,
	"MessageType_OkcoinTxRequest":        59,
	"MessageType_OkcoinTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_OkcoinSignMessage":      64,
	"MessageType_OkcoinVerifyMessage":    65,
	"MessageType_OkcoinMessageSignature": 66,
...
// *
// Request: Ask device for Okcoin address corresponding to address_n path
// @next PassphraseRequest
// @next OkcoinAddress
// @next Failure
type OkcoinGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *OkcoinGetAddress) Reset()                    { *m = OkcoinGetAddress{} }
func (m *OkcoinGetAddress) String() string            { return proto.CompactTextString(m) }
func (*OkcoinGetAddress) ProtoMessage()               {}
func (*OkcoinGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *OkcoinGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *OkcoinGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Okcoin address derived from device private seed
// @prev OkcoinGetAddress
type OkcoinAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *OkcoinAddress) Reset()                    { *m = OkcoinAddress{} }
func (m *OkcoinAddress) String() string            { return proto.CompactTextString(m) }
func (*OkcoinAddress) ProtoMessage()               {}
func (*OkcoinAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *OkcoinAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next OkcoinTxRequest
// @next Failure
type OkcoinSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *OkcoinSignTx) Reset()                    { *m = OkcoinSignTx{} }
func (m *OkcoinSignTx) String() string            { return proto.CompactTextString(m) }
func (*OkcoinSignTx) ProtoMessage()               {}
func (*OkcoinSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *OkcoinSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *OkcoinSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *OkcoinSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *OkcoinSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *OkcoinSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *OkcoinSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *OkcoinSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *OkcoinSignTx) GetDataLength() uint32 {
...
func (m *OkcoinSignTx) GetChainId() uint32 {
...
func (m *OkcoinTxRequest) Reset()                    { *m = OkcoinTxRequest{} }
func (m *OkcoinTxRequest) String() string            { return proto.CompactTextString(m) }
func (*OkcoinTxRequest) ProtoMessage()               {}
func (*OkcoinTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *OkcoinTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *OkcoinTxRequest) GetSignatureV() uint32 {
...
func (m *OkcoinTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *OkcoinTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev OkcoinTxRequest
// @next OkcoinTxRequest
type OkcoinTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *OkcoinTxAck) Reset()                    { *m = OkcoinTxAck{} }
func (m *OkcoinTxAck) String() string            { return proto.CompactTextString(m) }
func (*OkcoinTxAck) ProtoMessage()               {}
func (*OkcoinTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *OkcoinTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next OkcoinMessageSignature
// @next Failure
type OkcoinSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *OkcoinSignMessage) Reset()                    { *m = OkcoinSignMessage{} }
func (m *OkcoinSignMessage) String() string            { return proto.CompactTextString(m) }
func (*OkcoinSignMessage) ProtoMessage()               {}
func (*OkcoinSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *OkcoinSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *OkcoinSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type OkcoinVerifyMessage struct {
...
func (m *OkcoinVerifyMessage) Reset()                    { *m = OkcoinVerifyMessage{} }
func (m *OkcoinVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*OkcoinVerifyMessage) ProtoMessage()               {}
func (*OkcoinVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *OkcoinVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *OkcoinVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *OkcoinVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev OkcoinSignMessage
type OkcoinMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *OkcoinMessageSignature) Reset()                    { *m = OkcoinMessageSignature{} }
func (m *OkcoinMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*OkcoinMessageSignature) ProtoMessage()               {}
func (*OkcoinMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *OkcoinMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *OkcoinMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*OkcoinGetAddress)(nil), "OkcoinGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*OkcoinAddress)(nil), "OkcoinAddress")
	...
	proto.RegisterType((*OkcoinSignTx)(nil), "OkcoinSignTx")
	proto.RegisterType((*OkcoinTxRequest)(nil), "OkcoinTxRequest")
	proto.RegisterType((*OkcoinTxAck)(nil), "OkcoinTxAck")
	proto.RegisterType((*OkcoinSignMessage)(nil), "OkcoinSignMessage")
	proto.RegisterType((*OkcoinVerifyMessage)(nil), "OkcoinVerifyMessage")
	proto.RegisterType((*OkcoinMessageSignature)(nil), "OkcoinMessageSignature")
