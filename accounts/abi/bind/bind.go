...
// Package bind generates Okcoin contract Go bindings.
//
// Detailed usage document and tutorial available on the go-okcoin Wiki page:
// https://github.com/okcoin/go-okcoin/wiki/Native-DApps:-Go-bindings-to-Okcoin-contracts
package bind
...
// structured checks whokcer a list of ABI data types has enough information to
