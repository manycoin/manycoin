...
// Package accounts implements high level Okcoin account management.
package accounts
...
// Account represents an Okcoin account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Okcoin account address derived from the key
...
type Wallet interface {
	...
	// Contains returns whokcer an account is part of this particular wallet or not.
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain okcoin.ChainStateReader)
