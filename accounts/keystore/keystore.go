...
// See https://github.com/okcoin/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whokcer the event notification loop is running
...
// HasAddress reports whokcer a key with the given address is present.
...
// ImportPreSaleKey decrypts the given Okcoin presale wallet and stores
