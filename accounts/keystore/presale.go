...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/okcoin/pyokcsaletool

		pyokcsaletool generates the encryption key from password by
	...
	*/
	...
	okcPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(okcPriv)
	...
	expectedAddr := preSaleKeyStruct.OkcAddr
