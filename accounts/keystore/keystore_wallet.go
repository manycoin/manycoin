...
// Status implements accounts.Wallet, returning whokcer the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain okcoin.ChainStateReader) {}
