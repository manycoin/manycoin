...
// Whisper represents a dark communication interface through the Okcoin
...
// New creates a Whisper client ready to communicate through the Okcoin P2P network.
...
// param isP2P indicates whokcer the message is peer-to-peer (should not be forwarded).
