...
// returned from docker inspect, parsed into a form easily usable by puppokc.
type containerInfos struct {
	running bool              // Flag whokcer the container is running currently
...
func inspectContainer(client *sshClient, container string) (*containerInfos, error) {
	// Check whokcer there's a container running for the service
	...
	// Infos retrieved, parse the above into somokcing meaningful
