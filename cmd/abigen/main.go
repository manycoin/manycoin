...
import (
	...
	"github.com/okcoin/go-okcoin/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Okcoin contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Okcoin contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Okcoin contract Solidity source to build and bind")
