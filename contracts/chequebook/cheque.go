...
// Package chequebook package wraps the 'chequebook' Okcoin smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in okcer; (auto)cashing cheques in okcer
// as well as (auto)depositing okcer to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/okcoin/go-okcoin/contracts/chequebook/contract"
	"github.com/okcoin/go-okcoin/core/types"
	"github.com/okcoin/go-okcoin/crypto"
	"github.com/okcoin/go-okcoin/log"
	"github.com/okcoin/go-okcoin/swarm/services/swap/swap"
)
...
// * depositing okcer to the chequebook
// * watching incoming okcer
...
// Cash cashes the cheque by sending an Okcoin transaction.
