...
// Address represents the 20 byte address of an Okcoin account.
...
// IsHexAddress verifies whokcer a string can represent a valid hex-encoded
// Okcoin address or not.
